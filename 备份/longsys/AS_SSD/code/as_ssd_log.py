...
class AsSsdLog(object):
    ...
    def data_clean(self):
        ...
        Score = bs.find('Score')
        Score_Read = Score.find('Read').text
        Score_Write = Score.find('Write').text
        Score_Total = Score.find('Total').text
        print(Score_Read,Score_Write,Score_Total)
        ...
        data_dict['Score_Read'] = Score_Read
        data_dict['Score_Write'] = Score_Write
        data_dict['Score_Total'] = Score_Total
